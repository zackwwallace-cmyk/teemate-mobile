...
const disabledMessage = 'TeeMate+ purchases are temporarily disabled in this build. Store billing will be enabled after native subscription setup is stable.';
