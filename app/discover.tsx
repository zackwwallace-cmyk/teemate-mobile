...
const DISTANCE_FILTERS = ['50', '250', '500', 'any'];
...
export default function DiscoverScreen() {
  ...
  const filteredProfiles = useMemo(() => {
    return profiles.filter((profile) => {
      ...
      if (distanceFilter !== 'any') {
        ...
        if (miles == null || miles > Number(distanceFilter)) return false;
      }
      return true;
    });
  ...
  async function load() {
    ...
    setRefreshing(true);
    const [{ data: me }, { data, error }, { data: courses, error: courseError }] = await Promise.all([getMyProfile(session.user.id), getDiscoverProfiles(session.user.id), getMyProfileCourses(session.user.id)]);
  ...
  function resetFilters() { setGenderFilter('any'); setSkillFilter('any'); setAgeMin('18'); setAgeMax('99'); setIncludeUnsetAge(true); setDistanceFilter('50'); setCourseFilter('any'); }
...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: colors.background }, center: { flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.background }, content: { padding: 20, paddingBottom: 116 }, topbar: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between', marginBottom: 16, paddingTop: 4 }, iconButton: { alignItems: 'center', backgroundColor: colors.card, borderColor: colors.border, borderRadius: 999, borderWidth: 1, height: 40, justifyContent: 'center', width: 40 }, titleRow: { alignItems: 'flex-start', flexDirection: 'row', gap: 12, justifyContent: 'space-between' }, titleCopy: { flex: 1 }, pageTitle: { color: colors.pine, flexShrink: 1, fontSize: 30, fontWeight: '900', letterSpacing: -0.5 }, pageSubtitle: { color: colors.muted, fontSize: 14, lineHeight: 20, marginTop: 4 }, usageRow: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between', gap: 10, marginBottom: 14, marginTop: 8 }, nearby: { color: colors.muted, fontSize: 13, fontWeight: '800' }, usageText: { color: colors.muted, flex: 1, fontSize: 11, fontWeight: '800', textAlign: 'right' }, plusPill: { backgroundColor: colors.lime, borderRadius: 999, color: colors.ink, fontSize: 11, fontWeight: '900', overflow: 'hidden', paddingHorizontal: 9, paddingVertical: 5 }, filterButton: { alignItems: 'center', backgroundColor: colors.card, borderColor: colors.border, borderRadius: 999, borderWidth: 1, flexDirection: 'row', gap: 7, paddingHorizontal: 13, paddingVertical: 10, position: 'relative' }, filterButtonText: { color: colors.ink, fontSize: 13, fontWeight: '900' }, filterBadge: { alignItems: 'center', backgroundColor: colors.lime, borderRadius: 999, minWidth: 18, paddingHorizontal: 5, paddingVertical: 2 }, filterBadgeText: { color: colors.ink, fontSize: 10, fontWeight: '900' }, modalScreen: { flex: 1, backgroundColor: colors.background }, modalContent: { gap: 18, padding: 20, paddingBottom: 34 }, modalHeader: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between' }, modalTitle: { color: colors.pine, fontSize: 26, fontWeight: '900' }, closeButton: { alignItems: 'center', backgroundColor: colors.card, borderColor: colors.border, borderRadius: 999, borderWidth: 1, height: 42, justifyContent: 'center', width: 42 }, filterGroup: { gap: 6 }, filterLabel: { color: colors.ink, fontSize: 15, fontWeight: '900' }, filterLabelRow: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between' }, filterHelper: { color: colors.muted, fontSize: 12, lineHeight: 17 }, locationText: { color: colors.muted, fontSize: 13, fontWeight: '800' }, gpsButton: { alignItems: 'center', backgroundColor: colors.pine, borderRadius: 16, flexDirection: 'row', gap: 8, justifyContent: 'center', minHeight: 46 }, gpsText: { color: colors.cream, fontSize: 14, fontWeight: '900' }, zipRow: { alignItems: 'center', flexDirection: 'row', gap: 8 }, zipInput: { backgroundColor: colors.card, borderColor: colors.border, borderRadius: 16, borderWidth: 1, color: colors.ink, flex: 1, minHeight: 46, paddingHorizontal: 12 }, setButton: { alignItems: 'center', backgroundColor: colors.card, borderColor: colors.border, borderRadius: 16, borderWidth: 1, height: 46, justifyContent: 'center', paddingHorizontal: 18 }, setText: { color: colors.pine, fontWeight: '900' }, distanceBar: { backgroundColor: colors.border, borderRadius: 999, flexDirection: 'row', height: 4, justifyContent: 'space-between', marginTop: 8 }, distanceDot: { backgroundColor: colors.background, borderColor: colors.border, borderRadius: 999, borderWidth: 1, height: 18, marginTop: -7, width: 18 }, distanceDotActive: { backgroundColor: colors.pine, borderColor: colors.pine }, distanceLabels: { flexDirection: 'row', justifyContent: 'space-between' }, distanceLabel: { color: colors.muted, fontSize: 11, fontWeight: '800' }, ageRow: { flexDirection: 'row', gap: 10 }, ageBox: { backgroundColor: colors.card, borderColor: colors.border, borderRadius: 16, borderWidth: 1, flex: 1, padding: 10 }, ageLabel: { color: colors.muted, fontSize: 10, fontWeight: '900' }, ageInput: { color: colors.ink, fontSize: 18, fontWeight: '900', paddingVertical: 4 }, checkRow: { alignItems: 'center', flexDirection: 'row', gap: 8, marginTop: 4 }, filterRow: { gap: 8, paddingVertical: 4 }, filterChip: { backgroundColor: colors.card, borderColor: colors.border, borderRadius: 999, borderWidth: 1, paddingHorizontal: 12, paddingVertical: 9 }, filterChipActive: { backgroundColor: colors.pine, borderColor: colors.pine }, filterText: { color: colors.pine, fontSize: 13, fontWeight: '900', textTransform: 'capitalize' }, filterTextActive: { color: colors.cream }, noCourses: { color: colors.muted, fontSize: 13 }, modalActions: { flexDirection: 'row', gap: 10 }, resetButton: { alignItems: 'center', backgroundColor: colors.card, borderColor: colors.border, borderRadius: 16, borderWidth: 1, flex: 1, justifyContent: 'center', minHeight: 50 }, resetButtonText: { color: colors.pine, fontWeight: '900' }, applyButton: { alignItems: 'center', backgroundColor: colors.pine, borderRadius: 16, flex: 1, justifyContent: 'center', minHeight: 50 }, applyButtonText: { color: colors.cream, fontWeight: '900' }, profileCard: { backgroundColor: colors.card, borderColor: colors.border, borderRadius: 28, borderWidth: 1, overflow: 'hidden' }, hero: { alignItems: 'center', backgroundColor: colors.pine, height: 430, justifyContent: 'center', position: 'relative' }, tap: { backgroundColor: 'rgba(17,39,27,0.78)', borderRadius: 999, color: colors.cream, fontSize: 11, fontWeight: '900', left: 14, overflow: 'hidden', paddingHorizontal: 10, paddingVertical: 6, position: 'absolute', top: 14 }, scoreBadge: { alignItems: 'center', backgroundColor: colors.lime, borderRadius: 999, flexDirection: 'row', gap: 5, paddingHorizontal: 12, paddingVertical: 7, position: 'absolute', right: 14, top: 14 }, scoreText: { color: colors.ink, fontSize: 12, fontWeight: '900' }, founderBadge: { backgroundColor: '#FDE68A', borderRadius: 999, color: '#78350F', fontSize: 11, fontWeight: '900', overflow: 'hidden', paddingHorizontal: 10, paddingVertical: 5, position: 'absolute', right: 14, top: 54 }, heroInitial: { color: 'rgba(242,238,225,0.16)', fontSize: 128, fontWeight: '900' }, heroFooter: { bottom: 0, left: 0, padding: 20, position: 'absolute', right: 0 }, name: { color: colors.cream, fontSize: 28, fontWeight: '900' }, heroMeta: { color: 'rgba(242,238,225,0.86)', fontSize: 13, fontWeight: '800', marginTop: 4, textTransform: 'capitalize' }, cardBody: { padding: 18 }, bio: { color: colors.ink, fontSize: 14, lineHeight: 21 }, chips: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 12 }, chip: { backgroundColor: 'rgba(21,64,44,0.1)', borderRadius: 999, color: colors.pine, fontSize: 12, fontWeight: '900', overflow: 'hidden', paddingHorizontal: 10, paddingVertical: 7, textTransform: 'capitalize' }, actionRow: { alignItems: 'center', flexDirection: 'row', gap: 18, justifyContent: 'center', marginTop: 20 }, smallCircle: { alignItems: 'center', backgroundColor: colors.card, borderColor: colors.border, borderRadius: 999, borderWidth: 1, height: 64, justifyContent: 'center', width: 64 }, inviteButton: { alignItems: 'center', backgroundColor: colors.lime, borderColor: colors.pine, borderRadius: 999, borderWidth: 2, height: 78, justifyContent: 'center', width: 78 }, inviteText: { color: colors.pine, fontSize: 11, fontWeight: '900', marginTop: 1 }, empty: { alignItems: 'center', backgroundColor: colors.card, borderColor: colors.border, borderRadius: 28, borderWidth: 1, minHeight: 420, padding: 28, justifyContent: 'center' }, emptyIcon: { alignItems: 'center', backgroundColor: 'rgba(215,242,91,0.45)', borderRadius: 999, height: 72, justifyContent: 'center', width: 72 }, emptyTitle: { color: colors.pine, fontSize: 22, fontWeight: '900', marginTop: 14 }, emptyText: { color: colors.muted, fontSize: 14, lineHeight: 20, marginTop: 8, textAlign: 'center' }, detailScreen: { flex: 1, backgroundColor: colors.background }, detailContent: { paddingBottom: 36 }, backButton: { alignItems: 'center', backgroundColor: 'rgba(17,39,27,0.8)', borderRadius: 999, height: 44, justifyContent: 'center', left: 16, position: 'absolute', top: 16, width: 44, zIndex: 4 }, detailHero: { alignItems: 'center', backgroundColor: colors.pine, height: 330, justifyContent: 'center' }, detailInitial: { color: 'rgba(242,238,225,0.16)', fontSize: 126, fontWeight: '900' }, detailBody: { padding: 20 }, detailName: { color: colors.ink, fontSize: 29, fontWeight: '900' }, detailMeta: { color: colors.muted, fontSize: 13, fontWeight: '800', marginTop: 4, textTransform: 'capitalize' }, detailBio: { color: colors.ink, fontSize: 15, lineHeight: 22, marginTop: 16 }, statsGrid: { flexDirection: 'row', gap: 8, marginTop: 18 }, detailStat: { backgroundColor: colors.card, borderColor: colors.border, borderRadius: 16, borderWidth: 1, flex: 1, padding: 14 }, detailStatValue: { color: colors.pine, fontSize: 20, fontWeight: '900', textAlign: 'center' }, detailStatLabel: { color: colors.muted, fontSize: 10, fontWeight: '800', marginTop: 4, textAlign: 'center', textTransform: 'uppercase' }, infoGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 16 }, infoChip: { alignItems: 'center', backgroundColor: colors.card, borderColor: colors.border, borderRadius: 14, borderWidth: 1, flexDirection: 'row', gap: 7, paddingHorizontal: 12, paddingVertical: 10 }, infoChipText: { color: colors.ink, fontSize: 13, fontWeight: '800', textTransform: 'capitalize' }, sectionBlock: { marginTop: 18 }, sectionTitle: { color: colors.muted, fontSize: 11, fontWeight: '900', marginBottom: 8, textTransform: 'uppercase' }, detailActions: { alignItems: 'center', flexDirection: 'row', gap: 18, justifyContent: 'center', marginTop: 24 }, detailPass: { alignItems: 'center', backgroundColor: colors.card, borderColor: colors.border, borderRadius: 999, borderWidth: 1, height: 64, justifyContent: 'center', width: 64 }, detailInvite: { alignItems: 'center', backgroundColor: colors.lime, borderColor: colors.pine, borderRadius: 999, borderWidth: 2, height: 86, justifyContent: 'center', width: 132 }, promptOverlay: { alignItems: 'center', backgroundColor: 'rgba(17,39,27,0.42)', flex: 1, justifyContent: 'center', padding: 22 }, promptCard: { alignItems: 'center', backgroundColor: colors.card, borderRadius: 28, padding: 22, width: '100%' }, promptIcon: { alignItems: 'center', backgroundColor: colors.lime, borderRadius: 999, height: 62, justifyContent: 'center', marginBottom: 14, width: 62 }, promptTitle: { color: colors.pine, fontSize: 24, fontWeight: '900', textAlign: 'center' }, promptBody: { color: colors.muted, fontSize: 15, lineHeight: 22, marginTop: 10, textAlign: 'center' }, promptPrimary: { alignItems: 'center', backgroundColor: colors.pine, borderRadius: 18, justifyContent: 'center', marginTop: 18, minHeight: 54, width: '100%' }, promptPrimaryText: { color: colors.cream, fontSize: 16, fontWeight: '900' }, promptSecondary: { alignItems: 'center', justifyContent: 'center', marginTop: 10, minHeight: 44, width: '100%' }, promptSecondaryText: { color: colors.pine, fontSize: 15, fontWeight: '900' },
});
